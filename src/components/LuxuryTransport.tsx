    ...
    <section className="pt-12 pb-16">
      <div className="container-wrapper">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12 max-w-7xl mx-auto">
          <h2 className="text-base md:text-xl font-bold text-gray-900 mb-4 md:mb-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {vehicles.map((vehicle, index) => (
            ...
            >
              <h3 className="text-lg font-medium text-gray-900 mb-5">{vehicle.name}</h3>
              <div className="">
                <Image src={vehicle.image} alt={vehicle.name} width={290} height={72} className="w-full h-auto rounded-xl" />
              </div>
